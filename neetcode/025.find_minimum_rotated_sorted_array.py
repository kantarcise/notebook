...
class Solution:
    ...
    def find_min_funny(self, nums):

        # [3, 4, 5, 1, 2] -  min is 1  - 1 is at index 3

        # this is o(N), so also no.
        # LOL
        return min(nums)
    ...
    def find_min(self, nums):
        ...
        while left < right:
            ...
            if nums[mid] > nums[left]:
                ...
                # if this is True, then we know that in the middle of the sequence, there is 
                # a bigger value than at its left.
                ...
                # we shouldd focus on the smaller part
                right = mid
...
if __name__ == '__main__':
    ...
    print(sol.find_min([3,4,5,1,2]))
    print(sol.find_min([4,5,6,7,0,1,2]))
    print(sol.find_min([11,13,15,17]))
