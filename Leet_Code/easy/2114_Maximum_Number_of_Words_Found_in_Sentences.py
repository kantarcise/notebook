...
Input: sentences = ["please wait", 
                    "continue to fight", 
                    "continue to win"]
Output: 3
Explanation: It is possible that multiple sentences 
...
class Solution:
    def mostWordsFound_(self, sentences: List[str]) -> int:
        # get lengths and find max among them
        res = 0
