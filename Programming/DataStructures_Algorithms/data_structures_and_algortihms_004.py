...
# received, the start and stop values are reassigned to provide the desired semantcs.

# Python’s Built-In Functions

# When choosing names for the parameters, we use identifiers x, y, z for arbitrary numeric
...
# Ordering: max and min apply to any data type that supports a notion of 
# comparison, or to any collection of such values. Likewise, sorted can be used to produce
...
# operation through elements of a collection.
